...
#
# curl -LO https://bitbucket.org/fredli74/hashbox/downloads/hashback-mac-amd64-0.5.zip; unzip ./hashback-mac-amd64-0.5 -d /usr/local/bin/
curl -LO https://www.dropbox.com/s/og3a79yh4aqdda4/hashback-mac-amd64-0.5.zip ; unzip ./hashback-mac-amd64-0.5 -o -d /usr/local/bin/
