...
GOOS=darwin go build -o "$GOPATH/bin/hashbox/hashbox-mac"
GOOS=windows go build -o "$GOPATH/bin/hashbox/hashbox-windows.exe"
...
rm *.zip
zip -D "hashbox-mac-amd64-$1.zip"     "hashbox-mac"
zip -D "hashbox-windows-amd64-$1.zip" "hashbox-windows.exe"
zip -D "hashbox-freebsd-amd64-$1.zip" "hashbox-freebsd-amd64"
zip -D "hashbox-linux-armv7l-$1.zip"  "hashbox-linux-armv7l"
zip -D "hashback-mac-amd64-$1.zip"    "hashback"
zip -D "hashback-win-amd64-$1.zip"    "hashback.exe"
